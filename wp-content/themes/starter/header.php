<?php //Header Variables
    ...
    $site_favicon     = get_field('site_favicon','options');
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="icon" type="image/png" 
    href="<?php if($site_favicon) echo $site_favicon['url']; else echo get_template_directory_uri() . '/assets/img/your-favicon.png'; ?>">
  <?php wp_head(); ?>

  <script src="https://kit.fontawesome.com/cd518a6585.js"></script>
